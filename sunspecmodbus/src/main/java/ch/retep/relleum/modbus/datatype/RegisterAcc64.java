 ...
 * @author Peter
 */
public class RegisterAcc64 extends Read0X03 implements RetepLong {

    {
        setNanValue(new byte[]{(byte) 0X0, (byte) 0X0, (byte) 0X0, (byte) 0X0, (byte) 0X0, (byte) 0X0, (byte) 0X0, (byte) 0X0});
        setUnsigned(true);
    }
